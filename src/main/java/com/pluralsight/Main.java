...
public class Main {
    ...
    public static Book[] allLibraryBooks(){
        Book book1 = new Book(1, "9780743273565","The Great Gatsby", "F. Scott Fitzgerald","Classic / Fiction",1925,false, "none", null,null);
        ...
        Book book3 = new Book(3, "9780451524935","1984", "George Orwell","Dystopian / Science Fiction",1949,false, "none", null,null);
        ...
        Book book5 = new Book(5, "9780307277671","The Road", "Cormac McCarthy","Post-Apocalyptic / Fiction",2006,false, "none", null,null);
        ...
        Book book7 = new Book(7, "9780618640157","The Hobbit", "J.R.R. Tolkien","Fantasy",1937,false, "none", null, null);
        ...
        Book book9 = new Book(9, "9780553386790","A Game of Thrones", "George R.R. Martin","Fantasy",1996,false, "none", null, null);
        ...
        Book book11 = new Book(11, "9780307474278","he Girl with the Dragon Tattoo", "Stieg Larsson","Mystery / Thriller",2005,false, "none", null, null);
        ...
        Book book13 = new Book(13, "9781451673319","Fahrenheit 451", "Ray Bradbury","Dystopian / Science Fiction",1953,false, "none", null, null);
        ...
        Book book15 = new Book(15, "9780140449136","The Odyssey", "Homer","Epic / Classic",800,false, "none", null, null);
        ...
        Book book19 = new Book(19, "9780812981605","Gone Girl", "Gillian Flynn","Thriller / Mystery",2012,false, "none", null, null);
        ...
        Book book21 = new Book(21, "9780758260826","Such a Pretty Face", "Cathy Lamb","Fiction",2010,false, "none", null, null);
    ...
    public static String libraryMenuOptions(int userOption){
        ...
        return "Invalid option, please try again."; //invalid option, try again
    }
    public static void showAvailableBooks(Book[] arrayOfBooks){
        ...
        for (int i = 0; i < arrayOfBooks.length; i++){
            ...
            if (!arrayOfBooks[i].isCheckedOut()){ //checks if the book at the current index is checked out or not
                System.out.println(arrayOfBooks[i].displayBookInformation());
                userInputInt();
                if(arrayOfBooks[i].getId() == userInputInt()){
                     checkOutABook(arrayOfBooks[i]);
                }
            }
        }
    ...
    public static void checkOutABook(Book arrayOfBooks){
        arrayOfBooks.setCheckedOut();

    }

    public static void showCheckedOutBooks(Book arrayOfBooks[]){
        for (int i = 0; i < arrayOfBooks.length; i++){
            if (arrayOfBooks[i].isCheckedOut()){ //checks if the book at the current index is checked out or not
                System.out.println("------------------\nBook Id: " + arrayOfBooks[i].getId() + "\n" + arrayOfBooks[i].getTitle() + " was checked out on " +
                        arrayOfBooks[i].getDateBookWasCheckedOut() + " and is due to be back on " + arrayOfBooks[i].getDateBookIsDue() + "\n------------------");
            }
        }
        libraryHomeScreen();
    }
    ...
    public static String userInputString(){
        ...
        String readStringInput = read.nextLine();
